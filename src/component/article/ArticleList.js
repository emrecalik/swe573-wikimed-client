...
import { fetchPaginatedArticles } from "../../action/articleAction";
...
class ArticleList extends React.Component {
    ...
    callFetchAction = (pageNum) => {
        this.props.fetchPaginatedArticles(pageNum,
            () => history.push({
...
export default connect(mapStateToProps, { fetchPaginatedArticles })(ArticleList);